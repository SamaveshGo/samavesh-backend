...
async def run():
    async with async_playwright() as p:
        ...
        url = "https://moovitapp.com/tripplan/mumbai-3732/lines/en?customerId=4908&ref=4&query=MBMT%20(Mira%20Bhayandar%20Municipal%20Transport)&af_sub8=%252Findex%252Fen%252Fpublic_transit-lines-Mumbai-3732-983982&af_sub9=agency_show_all_lines"
        print(f"Navigating to MBMT: {url}...")
        ...
        print(f"Finished scrolling. Collected {len(lines)} unique MBMT lines in total.")
        
        script_dir = os.path.dirname(os.path.abspath(__file__))
        output_file = os.path.join(script_dir, "mbmt_lines_list.json")
