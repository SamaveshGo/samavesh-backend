...
async def run():
    async with async_playwright() as p:
        ...
        url = "https://moovitapp.com/tripplan/mumbai-3732/lines/en?customerId=4908&ref=4&query=UMT&af_sub8=%252Findex%252Fen%252Fpublic_transit-lines-Mumbai-3732-3775650&af_sub9=agency_show_all_lines"
        print(f"Navigating to UMT: {url}...")
        ...
        print(f"Finished scrolling. Collected {len(lines)} unique UMT lines in total.")
        
        script_dir = os.path.dirname(os.path.abspath(__file__))
        output_file = os.path.join(script_dir, "umt_lines_list.json")
