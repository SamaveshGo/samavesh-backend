...
async def run():
    async with async_playwright() as p:
        ...
        url = "https://moovitapp.com/tripplan/mumbai-3732/lines/en?customerId=4908&ref=4&query=KDMT%20(Kalyan%20Dombivli%20Municipal%20Transport%20Undertaking)&af_sub8=%2Findex%2Fen%2Fpublic_transit-lines-Mumbai-3732-888266&af_sub9=agency_show_all_lines"
        print(f"Navigating to KDMT: {url}...")
        ...
        print(f"Finished scrolling. Collected {len(lines)} unique KDMT lines in total.")
        
        script_dir = os.path.dirname(os.path.abspath(__file__))
        output_file = os.path.join(script_dir, "kdmt_lines_list.json")
